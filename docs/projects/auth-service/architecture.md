...
auth-service는 INGRADIENT 전체의 인증, 인가, 조직/프로젝트 접근 기초 사실을 관리하는 중앙 서비스다.
...
- Downstream 서비스가 membership과 project access를 조회한다
...
- Organization/Project scope 커스텀 역할 확장
